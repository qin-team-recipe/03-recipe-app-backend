...
// CreateFavoriteRecipe defines model for CreateFavoriteRecipe.
type CreateFavoriteRecipe struct {
	CreatedAt string `json:"createdAt"`
	Id        string `json:"id"`
...
// DeleteFavoriteRecipe defines model for DeleteFavoriteRecipe.
type DeleteFavoriteRecipe struct {
	CreatedAt string `json:"createdAt"`
	Id        string `json:"id"`
	RecipeId  string `json:"recipeId"`
	UsrId     string `json:"usrId"`
...
// ExistsFavoriteRecipe defines model for ExistsFavoriteRecipe.
type ExistsFavoriteRecipe struct {
